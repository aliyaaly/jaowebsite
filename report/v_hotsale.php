            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">ລາຍງານສິນຄ້າຂາຍດີ</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <form method="get">
                            <input type="hidden" name="d" value="report/hotsale" />
                            <div class="row">
                                <div class="col-md-2">
                            ...
                            <div class="box-footer">
                                <button type="reset" class="btn btn-default" onclick="document.location='?d=report/hotsale'">ຍົກເລີກ</button>
                                <button type="submit" class="btn btn-primary">ຄົ້ນຫາ</button>
                                <?php if ($_GET['strDate'] != '' && $_GET['endDate'] != '') { ?>
                                    <a href="report/ex_hotsale.php?strDate=<?= $_GET['strDate'] ?>&endDate=<?= $_GET['endDate'] ?>" target="_blank">
