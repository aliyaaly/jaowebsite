                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title">ຂໍ້ມູນອັດຕາແລກປ່ຽນໃໝ່</h4>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <form method = "post" action="?d=master/exchange" enctype="multipart/form-data">
                    <div class="modal-body">                                             
                        <div class="row">                                          
                           <div class="col-sm-12">                          
                            <div class="form-group">
                              <label>ຊື່ສະກຸນເງີນ</label>                             
                              <input type="text" name="txtexchangeName" class="form-control" required="">
                              <label>ອັດຕາແລກປຽນ</label>                             
                              <input type="text" name="txtrate" class="form-control" required="">
                            </div>
                          </div>                                                                                                      
                        </div>                                                                                 
                    </div>
                  ...
                  <?php
                      ...
                      ?>
                          ...
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title">ແກ້ໄຂຂໍ້ມູນອັດຕາການແລກປ່ຽນ</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <div class="form-group">
                                        <label>ຊື່ສະກຸນເງີນ</label>
                                        <input type="text" name="txtexchangeName1" class="form-control" required="" value="<?= $row[1] ?>">
                                       
                                        <label>ອັດຕາແລກປຽນ</label>
                                        <input type="text" name="txtrate1" class="form-control" required="" value="<?= $row[2] ?>">
                          ...
                          <tr>
                            ...
                            <td align="center">
                        <a href ="?d=master/exchange&del=<?=$row[0]?>" onclick="return confirm('ທ່ານຕ້ອງການລຶບແທ້ບໍ...?')" ><i class="far fa-trash-alt"></i></a>
                      </td>
                          </tr>
                      <?php $i++;
                        }
