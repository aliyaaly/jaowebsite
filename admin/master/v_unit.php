                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title">ຫົວໜ່ວຍໃຫມ່</h4>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <form method = "post" action="?d=master/unit" enctype="multipart/form-data">
                    <div class="modal-body">                                             
                        <div class="row">                                          
                           <div class="col-sm-12">                          
                            <div class="form-group">
                              <label>ຫົວໜ່ວຍ</label>                             
                              <input type="text" Name="txtunitName" class="form-control" required="">
                  ...
                  <?php
                      ...
                      ?>
                          ...
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title">ແກ້ໄຂຂໍ້ມູນຫົວໜ່ວຍ</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                                  ...
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="txtunitName1" class="form-control" required="" value="<?= $row[1] ?>">
                          ...
                          <tr>
                            ...
                            <td align="center">
                        <a href ="?d=master/unit&del=<?=$row[0]?>" onclick="return confirm('ທ່ານຕ້ອງການລຶບແທ້ບໍ...?')" ><i class="far fa-trash-alt"></i></a>
                      </td>
                          </tr>
                      <?php $i++;
                        }
