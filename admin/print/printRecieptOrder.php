...
$select = "SELECT MAX(id) FROM v_orders_details";
if ($result = $mysqli->query($select)) {

    $id = $result->fetch_row()[0];
}

$one = "SELECT * FROM v_orders WHERE id = $id";
...
$sql = "SELECT * FROM v_orders_details WHERE id = $id";
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>

<head>
    <title>ໃບບິນສັ່ງຊື້</title>
...
<!-- <body> -->
    ...
    <div id="pagesize">
        <div id="headbox">
            ...
            <div align="center">
                <h1 style="align-items: center;">ໃບບິນສັ່ງຊື້</h1>
            </div>
            ...
            <div style="display: flex;justify-content: space-between;">
                ...
                <p style="padding: 0 20px">ຊື່ພະນັກງານ: <?= $user ?></p>
                <p style="padding: 0 20px">ຜູ້ສະໜອງ: <?= $sup ?></p>
            ...
            <table border="1">
                ...
                ?>
                        <tr>
                            ...
                            <td style="padding: 0 5px; width: 38%;"><?= $row[2] ?></td>
                            <td style="padding: 0 5px; width: 38%;"><?= $row[3] ?></td>
                        </tr>
