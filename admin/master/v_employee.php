            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">ຂໍ້ມູນພະນັກງານໃໝ່</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <form method="post" action="?d=master/employee" enctype="multipart/form-data">
                  <div class="modal-body">
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          <label>ຊື່</label>
                          <input type="text" name="txtemployeeName" class="form-control" required="">
                          <label>ນາມສະກຸນ</label>
                          <input type="text" name="txtsurname" class="form-control" required="">
                          <label>ທີ່ຢູ່</label>
                          <textarea type="text" name="txtaddress" class="form-control" required="" rows="4" cols="50"></textarea>
                    ...
                    <tbody>
                      ...
                      ?>
                          ...
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title">ແກ້ໄຂຂໍ້ມູນພະນັກງານ</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <div class="form-group">
                                        <label>ຊື່</label>
                                        <input type="text" name="txtemployeeName1" class="form-control" required="" value="<?= $row[1] ?>">
                                        <label>ນາມສະກຸນ</label>
                                        <input type="text" name="txtsurname1" class="form-control" required="" value="<?= $row[2] ?>">
                                        <label>ທີ່ຢູ່</label>
                                        <textarea type="text" name="txtaddress1" class="form-control" required="" rows="4" cols="50"><?= $row[3] ?></textarea>
                                        <label>ເບີໂທລະສັບ</label>
                                        <input type="text" name="txttel1" class="form-control" required="" value="<?= $row[4] ?>">
                          ...
                          <tr>
                            ...
                            <td align="center">
                        <a href ="?d=master/employee&del=<?=$row[0]?>" onclick="return confirm('ທ່ານຕ້ອງການລຶບແທ້ບໍ...?')" ><i class="far fa-trash-alt"></i></a>
                      </td>
                          </tr>
                      <?php $i++;
                        }
